        ...
        <Dialog {...props} closeText={"סָגור"}>
            ...
            <div className={classes.root}>
                <NamedAvatar
                    ...
                    imageUrl={YoavImage}
                    linkedinUrl={
                        "https://www.linkedin.com/in/yoav-tepper-30283b131/"
                    }
                    EngName={"Yoav Tepper"}
                    HebName={"יואב טפר"}
                />
            ...
            <p style={{ textAlign: "center" }}>
                ...
                <p>
                    ...
                    <u>
                        <a
                            href="https://betaknesset.com/apps/votes"
                            rel="noreferrer"
                            target="_blank"
                        >
                            סימולטור ההצבעות
            ...
            <div className={classes.root}>
                <NamedAvatar
                    ...
                    imageUrl={OrImage}
                    linkedinUrl={
                        "https://www.linkedin.com/in/or-lichter-687867129/"
                    }
                    EngName={"Or Lichter"}
                    HebName={"אור ליכטר"}
                />
                <NamedAvatar
                    ...
                    imageUrl={ShaniImage}
                    linkedinUrl={
                        "https://www.linkedin.com/in/shani-perl-886859191"
                    }
                    EngName={"Shani Perl"}
                    HebName={"שני פרל"}
                />
